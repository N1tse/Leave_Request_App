<%-- 
    Document   : sbcd
    Created on : Mar 3, 2019, 3:52:49 PM
    Author     : ntsep
--%>
...
<html>
    <head>
       <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <title>Search By Committed Date</title>
    </head>
    <body>
        <div class="text-center">
        <h1>Search By Date Committed Request</h1>
        <a href="logout"><small>LOGOUT</small></a><br>
        <a href="homeAdmin"><small>BACK</small></a><br>
            <form method="POST" action="searchByDate" modelAttribute="r"> 
